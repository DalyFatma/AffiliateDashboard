...
const handleRefuse = () => {
  ...
  const onSubmitUpdateAffiliateProfile = async (
    ...
    try {
      ...
      updateAffiliateProfile["id_creation_date"] =
        selectedExpirationLicenceDate!.toDateString();
      if (selectedExpirationInsuranceDate!.toDateString() === undefined) {
      ...
      updateAffiliateProfile["vehicles"] = user?.vehicles!;
      updateAffiliateProfile["notes"] = user?.notes!;
      updateAffiliateProfile["fleetNumber"] = user?.fleetNumber!;
      updateAffiliateProfile["coverageDistance"] = user?.coverageDistance!;
      updateAffiliateProfile["coverageArea"] = user?.coverageArea!;
      ...
      updateAffiliateProfile["number_file"] = licenceNumber;
  ...
  const handleInputChange = () => {
    ...
    if (selectedExpirationLicenceDate !== null) {
      filledCount++;
    }
  ...
  const isNextButtonDisabled = () => {
    switch (activeVerticalTab) {
      case 1:
        return (
          !isLicenceNameStepValid() ||
          !isLicenceFileStepValid() ||
          !isLicenceDateStepValid()
        );
                    ...
                    <Row>
                      <Col lg={6} className="d-flex justify-content-start">
                        <p className="text-muted">
                          Please finalize these documents to complete your
                                ...
                                <Tab.Pane eventKey="1">
                                  ...
                                  <Col lg={12}>
                                    <div className="mb-3">
                                      ...
                                      <Form.Control
                                        ...
                                        onChange={handlePDFUploadLicence}
                                        type="file"
                                  ...
                                  <Col lg={12}>
                                    <div className="mb-3">
                                      ...
                                      <Flatpickr
                                        value={selectedExpirationLicenceDate!}
                                        onChange={
                                          handleExpirationLicenceDateChange
                                        }
